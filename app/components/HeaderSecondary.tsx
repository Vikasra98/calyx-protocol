  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-8">
        <nav className="flex gap-8 text-[#1C1C1E]">
          <Link href="/" className="hover:text-[#1e1e1f] text-xl">
            Home
          </Link>
          <Link href="/aboutUs" className="hover:text-[#1C1C1E] text-xl">
            About
          </Link>
          <a href="#" className="hover:text-[#1C1C1E] text-xl">
            GitHub
          </a>
          <a href="#" className="hover:text-[#1C1C1E] text-xl">
            Docs
