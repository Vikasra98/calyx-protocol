  ...
  return (
    <div className="bg-white text-black min-h-screen flex justify-center px-4 sm:px-8 lg:px-20 lg:py-[100px] py-10">
      <div className="max-w-5xl w-full">
        ...
        {/* Section */}
        <h2 className="text-4xl font-bold mb-5 font_title">Data Sharing</h2>
        <p className="lg:mb-[40px] mb-6 text-xl font-normal">
        ...
        {/* Section */}
        <h2 className="text-4xl font-bold mb-5 font_title">Data Security</h2>
        <p className="lg:mb-[40px] mb-6 text-xl font-normal">
        ...
        <p className="lg:mb-[40px] mb-6 text-xl font-normal">
          ...
          be reflected on this page, along with a new &quot;Last Updated&quot;
          date.
        </p>
