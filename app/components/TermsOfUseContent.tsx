      ...
      <div className="max-w-5xl w-full">
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="mb-6 text-base lg:text-xl font-normal">
              To use the Calyx Protocol and related services, you must meet the
              following criteria:
            </p>
            <div className="space-y-6 lg:ps-11 ps-9">
              <div>
                <h3 className="font_title font-bold lg:text-[28px] text-xl mb-2">
                  1. Legal Capacity
                </h3>
                <p className="text-xl">
          ...
          <section>
            ...
            <div className="space-y-6 lg:ps-11 ps-9">
              <p className="text-xl">
                <span className="font_title font-bold lg:text-[28px] text-xl mb-4">
                  1. Purpose
                </span>{" "}
                <p className="mt-4">
                  The Calyx Protocol provides infrastructure for the creation,
                  issuance, and consultation of BUDS (Blockchain Units of
                  Derived Signal). These services are intended for use in
                  verifying, recording, and propagating trusted data.
                </p>
              </p>
              <p className="text-xl">
                <span className="font_title font-bold lg:text-[28px] text-xl mb-4">
                ...
                <p className="mt-4">
                  ...
                  and only in the manner expressly permitted by Calyx.
                </p>
              </p>
              <div>
                <p className="text-xl">
              ...
              <p className="text-xl">
                ...
                <p className="mt-4">
                  ...
                  accuracy, and impartiality. Verifications submitted through
                  the protocol are binding representations and may be subject to
                  audit or challenge.
                </p>
              </p>
              <p className="text-xl">
                ...
                <p className="mt-4">
                  ...
                  terminate access to the services if misuse, fraudulent
                  activity, or violations of these Terms are detected.
                </p>
              </p>
            </div>
          </section>
            ...
            <div className="space-y-6 lg:ps-11 ps-9">
              ...
              <p className="text-xl">
                ...
                <p className="mt-4">
                  ...
                  your login credentials, API keys, and authentication tokens.
                  Any activity carried out under your account will be deemed
                  your responsibility.
                </p>
              </p>
              <p className="text-xl">
                ...
                <p className="mt-4">
                  Entities applying for verifier status or other roles within
                  the protocol must provide supporting documentation as required
                  by Calyx. All applications are subject to review and approval,
                  and Calyx reserves the right to accept, reject, or revoke
              ...
              <p className="text-xl">
                ...
                <p className="mt-4">
                  Calyx may suspend or terminate your account if you breach
                  these Terms, fail to meet eligibility criteria, or engage in
            ...
            <div className="space-y-6 lg:ps-11 ps-9">
              <p className="text-xl">
                ...
                <p className="mt-4">
                  ...
                  including but not limited to its design, architecture,
                  formulas (including the Calyx Arc™, Compound Matrix™, and
                  Inter-Entity Attribution Ledger), software, documentation,
                  trademarks, and visual identity, are owned by Calyx or its
                  licensors.
                </p>
              </p>
              <p className="text-xl">
                ...
                <p className="mt-4">
                  ...
                  license to access and use the protocol solely for lawful
                  purposes and in accordance with the functionality made
                  available to you.
                </p>
              </p>
              <div>
              ...
              <p className="text-xl">
                ...
                <p className="mt-4">
                  ...
                  (Blockchain Units of Derived Signal), those records become
                  part of the Calyx ledger and are licensed under the protocol
                  for public audit and interoperability.
                </p>
              </p>
              <p className="text-xl">
                <span className="font_title font-bold lg:text-[28px] text-xl mb-4">
                ...
                <p className="mt-4">
                  The protocol may interoperate with third-party frameworks,
                  APIs, or datasets. Such content remains the property of its
                  respective owners and may be subject to separate terms and
                  conditions.
                </p>
              </p>
            </div>
          ...
          <section>
            ...
            <div className="space-y-6 lg:ps-11 ps-9">
              <p className="text-xl">
                ...
                <p className="mt-4">
                  The Calyx Protocol provides infrastructure for the issuance
                  and consultation of BUDS (Blockchain Units of Derived Signal).
                  Calyx does not guarantee financial outcomes, investment
                  returns, regulatory approval, or business performance based on
                  the use of BUDS or the protocol.
                </p>
              </p>
              <p className="text-xl">
                <span className="font_title font-bold lg:text-[28px] text-xl mb-4">
              ...
              <p className="text-xl">
                ...
                <p className="mt-4">
                  ...
                  provided on an “as is” and “as available” basis. Calyx makes
                  no warranties, express or implied, regarding uninterrupted
                  access, security, error-free performance, or suitability for
            ...
            <div className="space-y-6 lg:ps-11 ps-9">
              <p className="text-xl">
                ...
                <p className="mt-4">
                  ...
                  contractors, and licensors disclaim all liability, whether in
                  contract, tort, statute, equity, or otherwise, for any direct,
                  indirect, incidental, consequential, punitive, exemplary, or
                  special damages, including without limitation loss of profits,
                  loss of revenue, loss of goodwill, loss of business
                  opportunities, loss of data, or business interruption, arising
                  from or relating in any way to your access to or use of the
                  Calyx Protocol.
                </p>
              </p>
              <p className="text-xl">
                ...
                <p className="mt-4">
                  ...
                  claims, damages, losses, liabilities, or costs arising under
                  or relating to these Terms or the protocol exceed one hundred
                  (100) U.S. dollars, regardless of the nature of the claim, the
                  number of incidents, or the theory of liability.
                </p>
              </p>
              <div>
                <p className="text-xl">
                  ...
                  <p className="my-4">Calyx bears no responsibility for:</p>
                </p>
                <ul className="list-disc pl-6 space-y-2 text-xl">
                  <li>
              ...
              <p className="text-xl">
                ...
                <p className="mt-4">
                  By accessing or using the protocol, you acknowledge that you
                  do so at your sole risk. You understand and agree that the
                  issuance and use of BUDS (Blockchain Units of Derived Signal)
                  carries inherent technological, regulatory, and market risks,
                  for which Calyx bears no responsibility.
                </p>
              </p>
              <p className="text-xl">
                <span className="font_title font-bold lg:text-[28px] text-xl mb-4">
                ...
                <p className="mt-4">
                  ...
                  regardless of whether Calyx has been advised of the
                  possibility of such damages, and regardless of whether any
          ...
          <section>
            ...
            <div className="space-y-6 lg:ps-11 ps-9">
              <p className="text-xl">
                ...
                <p className="mt-4">
                  These Terms, and any dispute, claim, or controversy arising
                  out of or relating to them, the Calyx Protocol, or the
                  issuance or use of BUDS (Blockchain Units of Derived Signal),
                  shall be governed exclusively by, and construed in accordance
                  with, the laws of Finland, without regard to its
              ...
              <p className="text-xl">
                ...
                <p className="mt-4">
                  ...
                  these Terms shall be brought exclusively in the competent
                  courts of Helsinki, Finland. You irrevocably consent to the
                  personal jurisdiction of such courts and waive any objection
                  to venue or forum on grounds of inconvenience or otherwise.
                </p>
              </p>
              <p className="text-xl">
                <span className="font_title font-bold lg:text-[28px] text-xl mb-4">
                ...
                <p className="mt-4">
                  ...
                  individual basis, and that you shall not participate in or
                  bring claims as a plaintiff, class member, or representative
                  in any purported class, consolidated, or collective action.
                </p>
              </p>
              <p className="text-xl">
                <span className="font_title font-bold lg:text-[28px] text-xl mb-4">
                ...
                <p className="mt-4">
                  ...
                  the Rules of the Arbitration Institute of the Finland Chamber
                  of Commerce. The arbitration shall be seated in Helsinki,
                  conducted in English, and the award shall be final and
                  binding.
                </p>
              </p>
              <p className="text-xl">
                ...
                <p className="mt-4">
                  If you are located in a jurisdiction where certain rights
                  cannot be waived or restricted by contract, nothing in these
                  Terms shall operate to waive such mandatory protections;
                  however, all other provisions of these Terms shall remain
          ...
          <section>
            ...
            <div className="space-y-6 lg:ps-11 ps-9">
              <p className="text-xl">
                ...
                <p className="mt-4">
                  Calyx reserves the sole and absolute right to modify, update,
                  or replace these Terms of Use, the Privacy Policy, and any
                  other related policies at any time, with or without notice,
              ...
              <p className="text-xl">
                ...
                <p className="mt-4">
                  ...
                  interface. Your continued access to or use of the protocol
                  after such posting constitutes your full acceptance of the
                  updated Terms.
                </p>
              </p>
              <p className="text-xl">
                ...
                <p className="mt-4">
                  Calyx may, but is not obligated to, provide direct notice
                  (e.g., email, dashboard notification) of material changes. You
                  are responsible for reviewing the Terms regularly to remain
                  informed of current obligations and restrictions.
                </p>
              </p>
              <p className="text-xl">
                <span className="font_title font-bold lg:text-[28px] text-xl mb-4">
              ...
              <p className="text-xl">
                ...
                <p className="mt-4">
                  If any amendment is held invalid or unenforceable, the
                  remaining provisions shall continue in full force and effect,
                  and the invalid portion shall be enforced to the maximum
                  extent permissible.
                </p>
              </p>
            </div>
